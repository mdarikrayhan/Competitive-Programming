...
int main()
{
        ...
        multicase
    {
        ...
        long long n, testxs = 0, a_point = 0;
        cin >> n;
        string a, b, ans;
        cin >> a >> b;
        ...
        rep(i, 0, n)
        {
            ...
            if (x != i)
            {
                ...
                ansvec[0].push_back(x + 1);

                ansvec[1].push_back(i);
        ...
        rep(i, 0, n)
        {
            ...
            if ((b[i] == '0' && testxs % 2 == 1) || (b[i] == '1' && testxs % 2 == 0))
        ...
        if (a_point == 0)
        {
            ...
            if (ans[0] == '1')
            {
                ...
                ansvec[0].push_back(1);

                ansvec[1].push_back(n);

                ansvec[0].push_back(1);

                ansvec[1].push_back(1);

                ansvec[0].push_back(2);
