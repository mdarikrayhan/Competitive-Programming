...
int main()
{
        ...
        multicase
    {
        ...
        int lowerlimit = 0,upperlimit = n - 1,answer = 0;
        while (lowerlimit < upperlimit)
        {
            if (arr[upperlimit] == 1)
                upperlimit--;
            else if (arr[lowerlimit] == 1 and arr[upperlimit] == 0)
            {
                answer++;
                lowerlimit++;
                upperlimit--;
            }
            else if (arr[lowerlimit] == 1 and arr[upperlimit] == 1)
            {
                lowerlimit++;
                upperlimit--;
            }
            else if (arr[lowerlimit] == 0 and arr[upperlimit] == 1)
                lowerlimit++;
