...
void testCase() {
    vector<unsigned ll> pex = {205420232704ull, 4300726075392ull, 9943141842944ull, 102772080771072ull,
                               234260485308416ull, 723091532955648ull, 1929901949378560ull, 7962145521006592ull,
                               16163718647774208ull, 36001995886165504ull, 72057594037927680ull, 144115188075855744ull,
                               ...
                               144099394269413248ull, 144050217612541824ull, 72048513284964096ull, 36027165100998144ull,
                               18010923323096064ull, 9005072994269184ull, 2251791223742464ull, 1125899906826240ull,
                               281474976645120ull, 140737488224256ull, 17592184995840ull, 4398042316800ull,
                               274810798080ull};

    int x, y;
    cin >> x >> y;
    if((pex[x] >> y) & 1) cout << "IN" << endl;
    else cout << "OUT" << endl;
}